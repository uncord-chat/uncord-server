...
// GenerateRecoveryCodes generates a set of recovery codes in the format "xxxx-xxxx" where each half is 4 hex
// characters. Each code represents 4 random bytes (32 bits of entropy).
